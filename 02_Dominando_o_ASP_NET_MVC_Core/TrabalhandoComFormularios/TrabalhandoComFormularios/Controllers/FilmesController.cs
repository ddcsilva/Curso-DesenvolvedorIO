...
namespace TrabalhandoComFormularios.Controllers
{
    public class FilmesController : Controller
    {
        private readonly TrabalhandoComFormulariosContext _context;

        public FilmesController(TrabalhandoComFormulariosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TrabalhandoComFormulariosContext.Filme'  is null.");
            }
            var filme = await _context.Filme.FindAsync(id);
            if (filme != null)
            {
